...
const SIDEBAR_ITEMS = [
  ...
  { name: "محصولات", icon: ShoppingBag, color: "#8B5CF6", href: "/dashboard/admin/products" },
  { name: "کاربران", icon: Users, color: "#EC4899", href: "/dashboard/admin/users" },
  { name: "دسته بندی ها", icon: Group, color: "#10B981", href: "/dashboard/admin/categories" },
  { name: "سفارشات", icon: ShoppingCart, color: "#F59E0B", href: "/dashboard/admin/orders" },
];
            ...
            <div key={item.href}>
              ...
              {item.name === "محصولات" && isProductsOpen && (
                ...
                >
                 ...
                 <Link href="/dashboard/admin/products/producttoggle">
