...
const AddProductModal: React.FC<{ onClose: () => void }> = ({ onClose }) => {
    ...
    const [filteredSubcategories, setFilteredSubcategories] = useState<Subcategory[]>([]);  // فیلتر شده برای زیر دسته‌بندی‌ها
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="mt-4 p-6 bg-gray-800 rounded-xl shadow-lg w-full max-w-lg">
                ...
                {successMessage && <ErrorHandler message={successMessage} type="success" />}
