...
const userData = [
	{ id: 1, name: "جان دو", email: "john@example.com", role: "مشتری", status: "فعال" },
	{ id: 2, name: "جین اسمیت", email: "jane@example.com", role: "مدیر", status: "فعال" },
	{ id: 3, name: "باب جانسون", email: "bob@example.com", role: "مشتری", status: "غیرفعال" },
	{ id: 4, name: "آلیس براون", email: "alice@example.com", role: "مشتری", status: "فعال" },
	{ id: 5, name: "چارلی ویلسون", email: "charlie@example.com", role: "مدیر انجمن", status: "فعال" },
];
							...
							>
								<td className='px-6 py-4 whitespace-nowrap'>
									<div className='flex items-center'>
										...
										<div className='ml-4'>
											<div className='text-sm font-medium text-gray-950'>{user.name}</div>
										</div>
									</div>
								</td>
								...
								<td className='px-6 py-4 whitespace-nowrap text-sm text-gray-300'>
									<button className='bg-indigo-500 text-white hover:text-indigo-100 px-6 py-2 rounded-xl ml-1'>ویرایش</button>
									<button className='bg-red-500 text-white hover:text-red-100 px-6 py-2 rounded-xl'>حذف</button>
								</td>
							</motion.tr>
						))}
					</tbody>
