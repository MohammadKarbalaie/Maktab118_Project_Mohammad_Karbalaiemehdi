  ...
  return (
    <div className="w-full bg-gray-200 bg-opacity-50 backdrop-blur-md mb-6 shadow-lg rounded-xl p-6 border">
      <div className="flex justify-between items-center mb-4">
        ...
        <button
          className="px-6 py-3 bg-gray-950
        ...
        <table className="table-auto w-full border rounded-md bg-white border-slate-200 ">
          <thead>
            <tr className="bg-slate-400 ">
              <th className="border-b border-slate-800 px-4 py-2 text-slate-100">
                تصویر
              </th>
              <th className="border-b border-slate-800 px-4 py-2 text-slate-100">
                سرگروه
          ...
          <tbody>
            {categories.map((category) => (
              <tr
                key={category.id}
                className="hover:bg-slate-100 cursor-pointer transition duration-200"
              >
                ...
                <td className="border-b border-slate-200 px-4 py-2 text-slate-700">
                  <div className="flex gap-4 justify-center">
                    <p className="text-xl text-sky-400 hover:text-sky-600 transition duration-200">
                      <BiEdit />
                    </p>
                    <p className="text-xl text-red-400 hover:text-red-600 transition duration-200">
                      <AiFillDelete />
                    </p>
                  </div>
                </td>
