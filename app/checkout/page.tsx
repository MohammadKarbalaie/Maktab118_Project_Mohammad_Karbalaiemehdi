...
function CheckoutPage() {
  ...
  const [selectedDeliveryDate, setSelectedDeliveryDate] = useState<DayValue>(null);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const orderData = {
      ...
      deliveryDate: new Date(selectedDeliveryDate.year, selectedDeliveryDate.month - 1, selectedDeliveryDate.day).toISOString(),
          ...
          <div className="mt-6 w-full space-y-6 sm:mt-8 lg:mt-0 lg:max-w-xs xl:max-w-md">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xl text-center bg-gray-800 rounded-2xl py-6 font-normal text-gray-500 dark:text-gray-400">
                تاریخ تحویل: {selectedDeliveryDate ? `${selectedDeliveryDate.year}/${selectedDeliveryDate.month}/${selectedDeliveryDate.day}` : 'تاریخ انتخاب نشده'}
              </p>
            </div>
          </div>
        </div>
